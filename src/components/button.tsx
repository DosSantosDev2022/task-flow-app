...
export function Button({
  ...
  const variantClasses = {
    ...
    highlight: `text-zinc-50 hover:bg-green-800 duration-300 bg-green-600 `,
  ...
  const _className = twMerge(
    ...
    `appearance-none rounded-md px-2 py-2 text-sm font-bold  transition-all duration-500 w-[96px] `,
    className,
  )
